...
For INC-4522, it queries Azure DNS from the web VM and uses the normal system resolver on the web, API, and database VMs. Each hostname must resolve to the correct VM's private IP. Port connectivity is checked separately by INC-4523.
